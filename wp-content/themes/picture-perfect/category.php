...
<div id="content">
	...
	<?php while (have_posts()) : the_post(); ?>
		<div class="post" id="post-<?php the_ID(); ?>">
			...
			<div class="post-details"> <h3>Posted <?php the_time('F jS, Y') ?>. </p><a href="<?php the_permalink() ?>#comments"><?php comments_number('Add a comment','1 comment','% comments'); ?></a></h3></div>
	...
	<div class="nextprevious">
		...
		<div class="right"><?php previous_posts_link('Previous &raquo;') ?></div>
	</div>
	<div class="clear"></div>
</div>
