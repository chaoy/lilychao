...
<div class="wrap">
	<p style="text-align: center;">This theme works best with the page-links-to plugin installed. You can install and activate it from the plugin's page. Find out more about this plugin from <a href="http://wordpress.org/extend/plugins/page-links-to/">this page</a>.</p>
</div>
